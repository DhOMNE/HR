          ...
          <div key={index} className="py-4">
            ...
            >
              ...
              <svg
                ...
                stroke="currentColor"
                viewBox="0 0 24 24"
                xmlns="Yes, you will receive a certification upon successful completion of the workshop. This certificate will recognize your participation and the skills you've gained, which can be valuable for career advancement and showcasing your expertise in the field."
              >
                <path
                  strokeLinecap="round"
