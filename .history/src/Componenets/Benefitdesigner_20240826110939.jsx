...
function Benefitdesigner() {
  return (
    // <div class="flex flex-col gap-10 lg:px-48 py-10 sm: px-10 py-10 ">
    ...
    //       {" "}
    //       Our program is designed to help you grow as a designer. Here are some
    //       of the benefits you'll get from completing the program.
    //     </p>
    ...
    //         </h2>
    //         <p class="text-[#49779c] text-sm font-normal leading-normal">
    //           Our curriculum is designed to help you master the skills needed in
    //           the industry
    //         </p>
    //       </div>
    //     </div>
    ...
    //         </h2>
    //         <p class="text-[#49779c] text-sm font-normal leading-normal">
    //           Get Job Opportunities like UI/UX Designer, User Experience
    //           Researcher, User Interface Designer, Interaction Designer, Product
    //           Designer, UX Analyst, UX/UI Developer, Visual Designer, UX
    //           Strategist, Design Consultant.
    //         </p>
    //       </div>
    //     </div>
    //   </div>
    ...
    //   </div>
    // </div>
    <div className="flex flex-col gap-10 px-4 py-10 @container flex flex-col gap-10 lg:px-48 py-10 sm: px-10 py-10">
