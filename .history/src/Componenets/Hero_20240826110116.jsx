        ...
        <div className="w-full">
          ...
          <div className="flex flex-col gap-10 px-4 py-10">
            <div className="flex flex-col gap-4">
              ...
              This is a 4-week program. Each week we'll cover a different aspect of HR. You'll learn by doing <br/>- we'll give you real-world projects to help you practice what you learn. Here's the breakdown:
              </p>
            </div>
