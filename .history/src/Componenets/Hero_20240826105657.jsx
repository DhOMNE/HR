    ...
    <div className="flex justify-center max-w-6xl mx-auto flex-col">
      <div className="w-full mt-16">
        <div
          ...
          style={{ backgroundImage: "url('https://cdn.usegalileo.ai/sdxl10/6b1c9f11-3bbc-4336-8f50-f084dce83415.png')" }}
        >
          ...
          <div className="flex flex-col gap-10 px-4 py-10">
            <div className="flex flex-col gap-4">
              ...
              <p className="text-gray-900 text-base font-normal leading-normal max-w-[720px]">
                This is a 4-week program. Each week we'll cover a different aspect of UI/UX design. You'll learn by doing - we'll give you real-world projects to help you practice what you learn. Here's the breakdown:
              </p>
            </div>
